...
Fill ExperienceForm
    ...
    Input Text      id=job-title        robot enter job title
    ...
    Wait Until Element Contains     xpath=//*[@id="root"]/div/div/div[3]     a new work experience ROBOT ENTER JOB TITLE is just created
